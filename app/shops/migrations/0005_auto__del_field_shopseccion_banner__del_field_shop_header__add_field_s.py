...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShopSeccion.banner'
        db.delete_column('shops_shopseccion', 'banner')

        # Deleting field 'Shop.header'
        db.delete_column('shops_shop', 'header')

        # Adding field 'Shop.banner'
        db.add_column('shops_shop', 'banner',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ShopSeccion.banner'
        db.add_column('shops_shopseccion', 'banner',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Shop.header'
        db.add_column('shops_shop', 'header',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Shop.banner'
        db.delete_column('shops_shop', 'banner')

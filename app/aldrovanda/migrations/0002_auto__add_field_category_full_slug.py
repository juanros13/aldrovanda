...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.full_slug'
        db.add_column('aldrovanda_category', 'full_slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.full_slug'
        db.delete_column('aldrovanda_category', 'full_slug')

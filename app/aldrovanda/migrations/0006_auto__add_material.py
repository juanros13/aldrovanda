...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aldrovanda_material', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('aldrovanda', ['Material'])

        # Adding M2M table for field material on 'Product'
        db.create_table('aldrovanda_product_material', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['aldrovanda.product'], null=False)),
            ('material', models.ForeignKey(orm['aldrovanda.material'], null=False))
        ))
        db.create_unique('aldrovanda_product_material', ['product_id', 'material_id'])


    def backwards(self, orm):
        # Deleting model 'Material'
        db.delete_table('aldrovanda_material')

        # Removing M2M table for field material on 'Product'
        db.delete_table('aldrovanda_product_material')

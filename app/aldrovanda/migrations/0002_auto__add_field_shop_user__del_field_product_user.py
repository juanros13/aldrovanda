...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.user'
        db.add_column('aldrovanda_shop', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Product.user'
        db.delete_column('aldrovanda_product', 'user_id')


    def backwards(self, orm):
        # Deleting field 'Shop.user'
        db.delete_column('aldrovanda_shop', 'user_id')

        # Adding field 'Product.user'
        db.add_column('aldrovanda_product', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)
